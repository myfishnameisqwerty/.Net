...
{
    public partial class DealDetails : Form
    {
        ...
        {
            foreach (Type mytype in Assembly.GetExecutingAssembly().GetTypes()
                  .Where(mytype => mytype.IsSubclassOf(typeof(UserControl))))
            {
        ...
        private void buildTicket()
        {
            ...
            m_TravelTicket.Birthday = DateTime.ParseExact(m_Operator.LoggedUser.Birthday,
                                                          "dd/MM/yyyy", null);
        }
